...
{{--    <link rel="stylesheet" href="{{ asset('css/style.css') }}">--}}
    <title>Господин Ребёнок — Регистрация</title>
    <style>
        ...
        * {
        ...
        /* декоративная строка категорий (только стиль) */
        .style-categories {
            display: flex;
            flex-wrap: wrap;
            gap: 12px 24px;
        ...
        /* карточка формы (как "Мягкая игрушка - Мишка") */
        .form-card {
...
<body>
    ...
    <div class="form-card">
        ...
        <div class="field-group">
            ...
            <input name="login" class="field-input" type="text" placeholder="Виктория">
        </div>

        <div class="field-group">
            <label class="field-label">Эл. почта</label>
            <input name="e-mail" class="field-input" type="email" placeholder="hello@mail.ru">
        </div>

        <div class="field-group">
            <label class="field-label">Пароль</label>
            <input name="password" class="field-input" type="password" placeholder="••••••••">
        </div>
